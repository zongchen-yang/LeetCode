<h2>1628. Design an Expression Tree With Evaluate Function</h2><h3>Medium</h3><hr><div><p>Given the <code>postfix</code> tokens of an arithmetic expression, build and return <em>the binary expression tree that represents this expression.</em></p>
...
<pre><strong>Input:</strong> s = ["4","2","+","3","5","1","-","*","+"]
<strong>Output:</strong> 18
</pre>

<p><strong>Example 4:</strong></p>

<pre><strong>Input:</strong> s = ["100","200","+","2","/","5","*","7","+"]
